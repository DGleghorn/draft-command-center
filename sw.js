...
self.addEventListener('message',e=>{if(e.data?.type==='SKIP_WAITING')self.skipWaiting();if(e.data?.type==='DCC_CHECK_VERSION')e.source?.postMessage({type:'DCC_UPDATE',version:'30.0'})});
